...
CITATION_TABLE = (
    ...
    ("security.md", "cli/commands.py:merge_stack_run:3112", "cli/commands.py",
     '"gh", "pr", "merge"'),
    ("security.md", "cli/commands.py:approve:5363", "cli/commands.py",
    ...
    ("security.md", "history/extractor.py:65-72", "history/extractor.py",
     "csrf_token"),
    # docs/eval.md
    ("eval.md", "src/no_human/cli/commands.py:bench_run:7930",
     "src/no_human/cli/commands.py", "different --trials are not resumed"),
    ("eval.md", ":bench_run:8081", "src/no_human/cli/commands.py", "asyncio.gather"),
    ("eval.md", ":bench_run:7959", "src/no_human/cli/commands.py",
     "(sc.task_id, sc.trial)"),
